...
var Controller = {
	...
	Player: {
		...
		init: function(stage, tracks) {
			...
			this.model.view.elementButtonVolUp.addEventListener('click', this.model.volUp.bind(this.model));
			this.model.view.elementButtonVolDown.addEventListener('click', this.model.volDown.bind(this.model));
		},
	},
