...
var Controller = {
	...
	Ball: {
		...
		init: function(stage) {
			...
			//this.model.view.element.addEventListener('click', this.model.view.disappear);  // not necessary anylonger
		},
	},
	...
	Pacman: {
		...
		init: function(stage) {
			...
			this.model.init(stage);
			window.addEventListener('deviceorientation', this.model.handleOrientation.bind(this));  // <-- add this
		},
	},
};